...
- [x] 接入 KarlHub 入口
- [x] 设置每天 08:00 PT 刷新数据与淘汰赛进度的 cron，持续到 2026-07-19
...
- 生产部署被本机 Vercel token 失效阻塞：`vercel --prod --yes` 返回 `The specified token is not valid. Use vercel login to generate a new token.`
- OpenClaw cron 已创建：`faaabd75-bd4b-474a-b8b1-7791f125a5a5`。
